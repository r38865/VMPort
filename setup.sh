...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/r38865/VMPort/main/access > /root/tmp
...
# https://raw.githubusercontent.com/r38865/VMPort/main/access 
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/r38865/VMPort/main/access | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/r38865/VMPort/main/access | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
echo ""
wget -q https://raw.githubusercontent.com/r38865/VMPort/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
wget https://raw.githubusercontent.com/r38865/VMPort/main/ssh/slhostdns.sh && chmod +x slhostdns.sh && ./slhostdns.sh

wget https://raw.githubusercontent.com/r38865/VMPort/main/ssh/install-sldns && chmod +x install-sldns && ./install-sldns
...
sleep 2
clear
wget https://raw.githubusercontent.com/r38865/VMPort/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/r38865/VMPort/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
wget https://raw.githubusercontent.com/r38865/VMPort/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
wget https://raw.githubusercontent.com/r38865/VMPort/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
echo -e "$green[INFO]$NC Download Extra Menu"
sleep 2
wget https://raw.githubusercontent.com/r38865/VMPort/main/update/update.sh && chmod +x update.sh && ./update.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/r38865/VMPort/main/version  )
...
clear
mkdir /etc/r38865
touch /etc/r38865/hello
echo 'script by ilyass najhi t.me/IlyassExE .. enjoy !' > /etc/r38865/hello
reboot
fi
