...
Isadmin=$(curl -sS https://raw.githubusercontent.com/r38865/VMPort/main/access | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/r38865/VMPort/main/access | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/r38865/VMPort/main/update/update.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/r38865/VMPort/main/version)
